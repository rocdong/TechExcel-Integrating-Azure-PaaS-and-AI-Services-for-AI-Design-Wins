...
public class DatabaseService : IDatabaseService
{
    ...
    public async Task<IEnumerable<Booking>> GetBookingsByHotelAndMinimumDate([Description("The ID of the hotel")] int hotelId, [Description("The booking datetime")] DateTime dt)
    {
    ...
    /// </summary>    
    [KernelFunction]
    [Description("Get all bookings for those without hotel rooms.")]
    ...
    /// </summary>   
    [KernelFunction]
    [Description("Get all bookings for those with multiple rooms.")]
